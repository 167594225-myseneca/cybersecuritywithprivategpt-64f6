[cybersecuritywithprivategpt-64f6] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-64f6] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-64f6] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39619  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='167594225-myseneca'  \-\-env DOCKERUSERNAME='jonalearning'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   jonalearning/cybersecuritywithprivategpt-64f6-amd64 (https://hub.docker.com/r/jonalearning/cybersecuritywithprivategpt-64f6-amd64)
...
.. code-block::
   ...
   docker run -d -p 42753:42753 -p 45219:45219 -p 55465:55465 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=cybersecuritywithprivategpt-64f6 \
          --env SOLUTIONDAG=solution_preprocessing_ml_ai_mqtt_dag-cybersecuritywithprivategpt-64f6 \
          --env GITUSERNAME=167594225-myseneca \
          --env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=42753 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=45219  \
          --env SOLUTIONVIPERVIZPORT=55465 \
          --env DOCKERUSERNAME='jonalearning' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=39619 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          ...
          jonalearning/cybersecuritywithprivategpt-64f6-amd64
...
[cybersecuritywithprivategpt-64f6] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/167594225-myseneca/cyt160-raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-64f6
...
.. important::
   https://cybersecuritywithprivategpt-64f6.readthedocs.io
...
.. important::
   solution_preprocessing_ml_ai_mqtt_dag-cybersecuritywithprivategpt-64f6
...
.. important::
   VIPERHOST_PRODUCE=10.1.0.4, VIPERPORT_PRODUCE=42753, VIPERHOST_PREPOCESS=10.1.0.4, VIPERPORT_PREPROCESS=40885, VIPERHOST_PREPOCESS2=10.1.0.4, VIPERPORT_PREPROCESS2=35123, VIPERHOST_PREPOCESS_PGPT=10.1.0.4, VIPERPORT_PREPROCESS_PGPT=40255, VIPERHOST_ML=10.1.0.4, VIPERPORT_ML=45143, VIPERHOST_PREDCT=10.1.0.4, VIPERPORT_PREDICT=34405, HPDEHOST=10.1.0.4, HPDEPORT=43863, HPDEHOST_PREDICT=10.1.0.4, HPDEPORT_PREDICT=41701

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9628-cybersecuritywithprivategpt-64f6,solution_preprocessing_ml_ai_mqtt_dag-cybersecuritywithprivategpt-64f6, python-preprocess-9156-cybersecuritywithprivategpt-64f6,solution_preprocessing_ml_ai_mqtt_dag-cybersecuritywithprivategpt-64f6, python-ml-8874-cybersecuritywithprivategpt-64f6,solution_preprocessing_ml_ai_mqtt_dag-cybersecuritywithprivategpt-64f6, python-predict-9369-cybersecuritywithprivategpt-64f6,solution_preprocessing_ml_ai_mqtt_dag-cybersecuritywithprivategpt-64f6, python-ai-2893-cybersecuritywithprivategpt-64f6,solution_preprocessing_ml_ai_mqtt_dag-cybersecuritywithprivategpt-64f6, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
